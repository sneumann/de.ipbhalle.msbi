...
public class ResultsParser {
	...
	public static void main(String[] args) {
		...
		try{
			...
			//candidate count
		    FileInputStream fstream = new FileInputStream("/home/swolf/MassBankData/MetFragSunGrid/HillPaperDataMerged/logs/2009-10-26_16-01-08_histCompare.txt");
//		    FileInputStream fstream = new FileInputStream("/home/swolf/MassBankData/MetFragSunGrid/HillPaperDataMerged/logs/2009-10-27_00-57-11_histCompare.txt");
		...
		try{
			...
			//FOUND PEAKS
		    FileInputStream fstream = new FileInputStream("/home/swolf/MassBankData/MetFragSunGrid/HillPaperDataMerged/logs/2009-10-26_16-01-08g_FoundPeaks.txt");
//		    FileInputStream fstream = new FileInputStream("/home/swolf/MassBankData/MetFragSunGrid/HillPaperDataMerged/logs/2009-10-27_00-57-11_FoundPeaks.txt");
		    // Get the object of DataInputStream
		    DataInputStream in = new DataInputStream(fstream);
		        BufferedReader br = new BufferedReader(new InputStreamReader(in));
		    String strLine;
...
//		    System.out.println(addFound(peakToCountFound, file));
		    ...
		    try{
				...
				//all peaks excluded
		    	FileInputStream fstream = new FileInputStream("/home/swolf/MassBankData/MetFragSunGrid/HillPaperDataMerged/logs/2009-10-26_16-01-08_AllPeaksInclusive.txt");
//			    FileInputStream fstream = new FileInputStream("/home/swolf/MassBankData/MetFragSunGrid/HillPaperDataMerged/logs/2009-10-27_00-57-11_AllPeaksInclusive.txt");
			    // Get the object of DataInputStream
			    DataInputStream in = new DataInputStream(fstream);
			    BufferedReader br = new BufferedReader(new InputStreamReader(in));
			    String strLine;
